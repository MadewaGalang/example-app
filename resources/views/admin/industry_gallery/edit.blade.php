...
<head>
    ...
    <title>{{ $title ?? 'Edit Galeri' }} - VENDREDI SAINT</title>
            ...
            <div class="p-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-8 w-full">
                    ...
                    <form id="editGalleryForm"
                        action="{{ route('admin.industry_gallery.update', $gallery->id) }}"
                        method="POST"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-3">
                                ...
                                @elseif($gallery->media_type == 'video')
                                    <video class="h-32 rounded-lg border" controls>
